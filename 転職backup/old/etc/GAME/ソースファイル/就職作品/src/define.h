...
#define	JUMP_MAX			40								// プレイヤーのジャンプカウント
...
#define ENEMY_MAX			10								// 敵キャラクターの最大数
...
// キャラクター状態列挙
enum {
	STAND = 0, DASH, BACK, LSTEP, RSTEP, LDASH, RDASH, LBACK, RBACK, ATTACK, DASH_ATTACK, JUMP, DAMAGE, DEATH,
};
