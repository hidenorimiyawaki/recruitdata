// SpriteTool.h : SPRITETOOL アプリケーションのメイン ヘッダー ファイル
//

#if !defined(AFX_SPRITETOOL_H__34C3E593_458A_40F3_A51E_529FB3ECD478__INCLUDED_)
#define AFX_SPRITETOOL_H__34C3E593_458A_40F3_A51E_529FB3ECD478__INCLUDED_
...
/////////////////////////////////////////////////////////////////////////////
// CSpriteToolApp:
// このクラスの動作の定義に関しては SpriteTool.cpp ファイルを参照してください。
//

class CSpriteToolApp : public CWinApp
{
public:
	CSpriteToolApp();
	//---------------汎用的に使用、代入される変数---------------
	...
	CCashDialog			CashDialog;					// 上記の変数に実体をぶち込むためのダイアログのインスタンス
	...
	int					AlphaFlg;					// グリッドにカーソルがフィットするかしないかのフラグ
...
// インプリメンテーション
	...
	afx_msg void OnIdAlphaOn();
	afx_msg void OnIdAlphaOff();
	afx_msg void OnIdModeDivide();
	afx_msg void OnIdModeSet();
	//}}AFX_MSG
	DECLARE_MESSAGE_MAP()
};
...
#endif // !defined(AFX_SPRITETOOL_H__34C3E593_458A_40F3_A51E_529FB3ECD478__INCLUDED_)
