========================================================================
       MICROSOFT FOUNDATION CLASS ライブラリ : SpriteTool
========================================================================


AppWizard が生成した SpriteTool には、Microsoft Foundation Class の基本的な
使い方が示されています。アプリケーション作成のひな型としてお使いください。

このファイルには SpriteTool を構成している各ファイルの概要説明が含まれています。
...
SpriteTool.h
    ...
    みます） をインクルードし、また CSpriteToolApp アプリケーションクラスを宣
    言します。

SpriteTool.cpp
    このファイルは CSpriteToolApp アプリケーションクラスを含むアプリケーション
    の中心となるソースファイルです。
...
res\SpriteTool.ico
    ...
    ルです。このアイコンはリソース ファイル SpriteTool.rc によってインクルード
    されます。
...
SpriteToolDoc.h, SpriteToolDoc.cpp - ドキュメント
    これらのファイルは CSpriteToolDoc クラスを含みます。特別なドキュメント デ
    ータを付け加えたり、CSpriteToolDoc::Serialize を使ったファイルのセーブや
    ロード機能をインプリメントしたいときはこのファイルを編集してください。

SpriteToolView.h, SpriteToolView.cpp - ビュー
    これらのファイルは CSpriteToolView クラスを含みます。
    CSpriteToolView オブジェクトは CSpriteToolDoc オブジェクトを表示するために
    使います。
...
StdAfx.h, StdAfx.cpp
    これらのファイルはプリコンパイル済ヘッダー ファイル (PCH) SpriteTool.pch 
