========================================================================
       MICROSOFT FOUNDATION CLASS ライブラリ : ScripteEditor
========================================================================


AppWizard が生成した ScripteEditor には、Microsoft Foundation Class の基本的な
使い方が示されています。アプリケーション作成のひな型としてお使いください。

このファイルには ScripteEditor を構成している各ファイルの概要説明が含まれています。
...
ScripteEditor.h
    ...
    みます） をインクルードし、また CScripteEditorApp アプリケーションクラスを宣
    言します。

ScripteEditor.cpp
    このファイルは CScripteEditorApp アプリケーションクラスを含むアプリケーション
    の中心となるソースファイルです。
...
res\ScripteEditor.ico
    このファイルは、アプリケーションのアイコンとして使用されるアイコンファイ
    ルです。このアイコンはリソース ファイル ScripteEditor.rc によってインクルード
    されます。

res\ScripteEditor.rc2
...
ScripteEditorDlg.h, ScripteEditorDlg.cpp - ダイアログ
    これらのファイルは CScripteEditorDlg クラスを含みます。このクラスは 
    アプリケーションのメイン ダイアログの動作を定義します。ダイアログ
    テンプレートは Microsoft Visual C++ で編集可能な ScripteEditor.rc に含
    まれます。
...
StdAfx.h, StdAfx.cpp
    これらのファイルはプリコンパイル済ヘッダー ファイル (PCH) ScripteEditor.pch 
