========================================================================
       MICROSOFT FOUNDATION CLASS ライブラリ : RenbanEditor
========================================================================


AppWizard が生成した RenbanEditor には、Microsoft Foundation Class の基本的な
使い方が示されています。アプリケーション作成のひな型としてお使いください。

このファイルには RenbanEditor を構成している各ファイルの概要説明が含まれています。
...
RenbanEditor.h
    ...
    みます） をインクルードし、また CRenbanEditorApp アプリケーションクラスを宣
    言します。

RenbanEditor.cpp
    このファイルは CRenbanEditorApp アプリケーションクラスを含むアプリケーション
    の中心となるソースファイルです。
...
res\RenbanEditor.ico
    このファイルは、アプリケーションのアイコンとして使用されるアイコンファイ
    ルです。このアイコンはリソース ファイル RenbanEditor.rc によってインクルード
    されます。

res\RenbanEditor.rc2
...
RenbanEditorDlg.h, RenbanEditorDlg.cpp - ダイアログ
    これらのファイルは CRenbanEditorDlg クラスを含みます。このクラスは 
    アプリケーションのメイン ダイアログの動作を定義します。ダイアログ
    テンプレートは Microsoft Visual C++ で編集可能な RenbanEditor.rc に含
    まれます。
...
StdAfx.h, StdAfx.cpp
    これらのファイルはプリコンパイル済ヘッダー ファイル (PCH) RenbanEditor.pch 
