========================================================================
       MICROSOFT FOUNDATION CLASS ライブラリ : DougaEditor
========================================================================


AppWizard が生成した DougaEditor には、Microsoft Foundation Class の基本的な
使い方が示されています。アプリケーション作成のひな型としてお使いください。

このファイルには DougaEditor を構成している各ファイルの概要説明が含まれています。
...
DougaEditor.h
    ...
    みます） をインクルードし、また CDougaEditorApp アプリケーションクラスを宣
    言します。

DougaEditor.cpp
    このファイルは CDougaEditorApp アプリケーションクラスを含むアプリケーション
    の中心となるソースファイルです。
...
res\DougaEditor.ico
    ...
    ルです。このアイコンはリソース ファイル DougaEditor.rc によってインクルード
    されます。
...
DougaEditorDlg.h, DougaEditorDlg.cpp - ダイアログ
    これらのファイルは CDougaEditorDlg クラスを含みます。このクラスは 
    アプリケーションのメイン ダイアログの動作を定義します。ダイアログ
    テンプレートは Microsoft Visual C++ で編集可能な DougaEditor.rc に含
    まれます。
...
StdAfx.h, StdAfx.cpp
    これらのファイルはプリコンパイル済ヘッダー ファイル (PCH) DougaEditor.pch 
