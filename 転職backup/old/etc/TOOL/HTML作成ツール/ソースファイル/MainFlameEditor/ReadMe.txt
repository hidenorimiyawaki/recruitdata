========================================================================
       MICROSOFT FOUNDATION CLASS ライブラリ : MainFlameEditor
========================================================================


AppWizard が生成した MainFlameEditor には、Microsoft Foundation Class の基本的な
使い方が示されています。アプリケーション作成のひな型としてお使いください。

このファイルには MainFlameEditor を構成している各ファイルの概要説明が含まれています。
...
MainFlameEditor.h
    ...
    みます） をインクルードし、また CMainFlameEditorApp アプリケーションクラスを宣
    言します。

MainFlameEditor.cpp
    このファイルは CMainFlameEditorApp アプリケーションクラスを含むアプリケーション
    の中心となるソースファイルです。
...
res\MainFlameEditor.ico
    このファイルは、アプリケーションのアイコンとして使用されるアイコンファイ
    ルです。このアイコンはリソース ファイル MainFlameEditor.rc によってインクルード
    されます。

res\MainFlameEditor.rc2
...
MainFlameEditorDlg.h, MainFlameEditorDlg.cpp - ダイアログ
    これらのファイルは CMainFlameEditorDlg クラスを含みます。このクラスは 
    アプリケーションのメイン ダイアログの動作を定義します。ダイアログ
    テンプレートは Microsoft Visual C++ で編集可能な MainFlameEditor.rc に含
    まれます。
...
StdAfx.h, StdAfx.cpp
    これらのファイルはプリコンパイル済ヘッダー ファイル (PCH) MainFlameEditor.pch 
