================================================================================
    MICROSOFT FOUNDATION CLASS ライブラリ : particleediter プロジェクトの概要
===============================================================================



    アプリケーション ウィザードが作成した particleediter には Microsoft 
    Foundation Classes の基本的な使い方が示されています。アプリケーション作成のひな型としてお使い
    ください。
    このファイルには particleediter アプリケーションを構成している各ファイルの概要説明が含
    まれています。

particleediter.vcproj
...
particleediter.h
    ...
    も含み、他のプロジェクト特定のヘッダが含まれていて、CparticleediterApp アプリケーション クラス
    の宣言をします。

particleediter.cpp
    このファイルは CparticleediterApp アプリケーションクラスを含むアプリケーションの中心となるソー
    スファイルです。
...
res\particleediter.ico
    このファイルは、アプリケーションのアイコンとして使用されるアイコンファイルです。このアイコンは
    リソース ファイル particleediter.rc によってインクルードされます。

res\particleediter.rc2
...
particleediterDoc.h, particleediterDoc.cpp - ドキュメント
    これらのファイルは CparticleediterDoc クラスを含みます。特別なドキュメント データを付け加えた 
    り、ファイルの保存や (via CparticleediterDoc::Serialize) を読み込んだりするには、このファイル 
    を編集してください。
particleediterView.h, particleediterView.cpp - ドキュメントのビュー
    これらのファイルは CparticleediterView クラスを含みます。
    CparticleediterView オブジェクトは CparticleediterDoc オブジェクトを表示するために使用され 
    ます。
/////////////////////////////////////////////////////////////////////////////
...
StdAfx.h, StdAfx.cpp
    これらのファイルは既にコンパイルされたヘッダー ファイル (PCH) particleediter.pch や既にコン 
