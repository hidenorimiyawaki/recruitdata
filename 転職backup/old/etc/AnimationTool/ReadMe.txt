========================================================================
       MICROSOFT FOUNDATION CLASS ライブラリ : AnimationTool
========================================================================


AppWizard が生成した AnimationTool には、Microsoft Foundation Class の基本的な
使い方が示されています。アプリケーション作成のひな型としてお使いください。

このファイルには AnimationTool を構成している各ファイルの概要説明が含まれています。
...
AnimationTool.h
    ...
    みます） をインクルードし、また CAnimationToolApp アプリケーションクラスを宣
    言します。

AnimationTool.cpp
    このファイルは CAnimationToolApp アプリケーションクラスを含むアプリケーション
    の中心となるソースファイルです。
...
res\AnimationTool.ico
    ...
    ルです。このアイコンはリソース ファイル AnimationTool.rc によってインクルード
    されます。
...
AnimationToolDoc.h, AnimationToolDoc.cpp - ドキュメント
    これらのファイルは CAnimationToolDoc クラスを含みます。特別なドキュメント デ
    ータを付け加えたり、CAnimationToolDoc::Serialize を使ったファイルのセーブや
    ロード機能をインプリメントしたいときはこのファイルを編集してください。

AnimationToolView.h, AnimationToolView.cpp - ビュー
    これらのファイルは CAnimationToolView クラスを含みます。
    CAnimationToolView オブジェクトは CAnimationToolDoc オブジェクトを表示するために
    使います。
...
StdAfx.h, StdAfx.cpp
    これらのファイルはプリコンパイル済ヘッダー ファイル (PCH) AnimationTool.pch 
