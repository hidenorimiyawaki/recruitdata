...
===============================================================================
    ...
    ください。
    このファイルには test アプリケーションを構成している各ファイルの概要説明が含
    まれています。
...
test.h
    ...
    も含み、他のプロジェクト特定のヘッダが含まれていて、CtestApp アプリケーション クラス
    の宣言をします。

test.cpp
    このファイルは CtestApp アプリケーションクラスを含むアプリケーションの中心となるソー
    スファイルです。
...
res\test.ico
    ...
    リソース ファイル test.rc によってインクルードされます。
...
MainFrm.h, MainFrm.cpp
    これらのファイルは、 から派生しすべての MDI フレーム機 能を制御するフレーム 
    クラス CMainFrame CMDIFrameWnd を含みます。
...
res\Toolbar.bmp
    ...
    編集し、test.rc ファイル内の IDR_MAINFRAME TOOLBAR 配列を変更してください。
/////////////////////////////////////////////////////////////////////////////
...
testDoc.h, testDoc.cpp - ドキュメント
    これらのファイルは CtestDoc クラスを含みます。特別なドキュメント データを付け加えた 
    り、ファイルの保存や (via CtestDoc::Serialize) を読み込んだりするには、このファイル 
    を編集してください。
testView.h, testView.cpp - ドキュメントのビュー
    これらのファイルは CtestView クラスを含みます。
    CtestView オブジェクトは CtestDoc オブジェクトを表示するために使用され 
    ます。
res\testDoc.ico
    このファイルは CtestDoc クラスの MDI 子ウィンドウ用アイコンとして使われるアイコン  
    ファイルです。このアイコンはリソースファイル test.rc によってインクルード 
    されます。
/////////////////////////////////////////////////////////////////////////////
...
StdAfx.h, StdAfx.cpp
    これらのファイルは既にコンパイルされたヘッダー ファイル (PCH) test.pch や既にコン 
