...
const ANIME		SP_STAND_F[] = {
	{ sp_01_f_Char, SIZE32x32, 0, 0, 0, SP_BODY_F, 0, 0, 0 },
};
// 横
const ANIME		SP_STAND_S[] = {
	{ sp_01_s_Char, SIZE32x32, 0, 0, 0, SP_BODY_S, 0, 0, 0 },
};
// 後
const ANIME		SP_STAND_R[] = {
	{ sp_01_r_Char, SIZE32x32, 0, 0, 0, SP_BODY_F, 0, 0, 0 },
};

// ****移動状態
// 前
const ANIME		SP_WALK_F[] = {
	{ sp_11_f_Char, SIZE32x32, 8, 0, 0, SP_BODY_F, 0, 0, 0 },
	{ sp_12_f_Char, SIZE32x32, 8, 0, 0, SP_BODY_F, 0, 0, 0 },
	{ sp_13_f_Char, SIZE32x32, 8, 0, 0, SP_BODY_F, 0, 0, 0 },
	{ sp_14_f_Char, SIZE32x32, 8, 0, 0, SP_BODY_F, 0, 0, 0 },
	{ NULL, 0xED, 0xED, 0xED, 0xED, 0, 0, 0, 0 }	// 終端データ

};
// 横
const ANIME		SP_WALK_S[] = {
	{ sp_11_s_Char, SIZE32x32, 8, 0, 0, SP_BODY_S, 0, 0, 0 },
	{ sp_12_s_Char, SIZE32x32, 8, 0, 0, SP_BODY_S, 0, 0, 0 },
	{ sp_13_s_Char, SIZE32x32, 8, 0, 0, SP_BODY_S, 0, 0, 0 },
	{ sp_14_s_Char, SIZE32x32, 8, 0, 0, SP_BODY_S, 0, 0, 0 },
	{ NULL, 0xED, 0xED, 0xED, 0xED, 0, 0, 0, 0 }	// 終端データ
};
// 後
const ANIME		SP_WALK_R[] = {
	{ sp_11_r_Char, SIZE32x32, 8, 0, 0, SP_BODY_F, 0, 0, 0 },
	{ sp_12_r_Char, SIZE32x32, 8, 0, 2, SP_BODY_F, 0, 0, 0 },
	{ sp_13_r_Char, SIZE32x32, 8, 0, 0, SP_BODY_F, 0, 0, 0 },
	{ sp_14_r_Char, SIZE32x32, 8, 0, 2, SP_BODY_F, 0, 0, 0 },
	{ NULL, 0xED, 0xED, 0xED, 0xED, 0, 0, 0, 0 }	// 終端データ
};
...
const ANIME		SP_ATK_F[] = {
	{ sp_21_f_Char, SIZE32x32, 8,  1, 2, 0, SP_ATK_D, 0, 0 },
	{ sp_22_f_Char, SIZE32x64, 4,  4, 3, 0, SP_ATK_D,10, 0 },
	{ sp_23_f_Char, SIZE32x32, 4, -1, 2, 0,        0, 0, 0 },
	{ sp_24_f_Char, SIZE32x32, 8, -1, 2, 0,        0, 0, 0 },
	{ NULL, 0xED, 0xED, 0xED, 0xED, 0, 0, 0, 0 }	// 終端データ
};
const ANIME		SP_ATK2_F[] = {
	{ sp_25_f_Char, SIZE32x32,  8, -1, 2, 0, SP_ATK2_D, 0, 0 },
	{ sp_26_f_Char, SIZE32x64,  4,  0, 3, 0, SP_ATK2_D,20, 0 },
	{ sp_27_f_Char, SIZE32x32, 16, -1, 2, 0,         0, 0, 0 },
	{ NULL, 0xED, 0xED, 0xED, 0xED, 0, 0, 0, 0 }	// 終端データ
};
// 横
const ANIME		SP_ATK_S[] = {
	{ sp_21_s_Char, SIZE32x32, 8,  0, 0, 0, SP_ATK_RL, 0, 0 },
	{ sp_22_s_Char, SIZE64x32, 4,  0, 0, 0, SP_ATK_RL,10, 0 },
	{ sp_23_s_Char, SIZE32x32, 4,  6, 0, 0,         0, 0, 0 },
	{ sp_24_s_Char, SIZE32x32, 8,  6, 0, 0,         0, 0, 0 },
	{ NULL, 0xED, 0xED, 0xED, 0xED, 0, 0, 0, 0 }	// 終端データ
};
const ANIME		SP_ATK2_S[] = {
	{ sp_25_s_Char, SIZE32x32, 8, -1, 0, 0, SP_ATK2_RL, 0, 0 },
	{ sp_26_s_Char, SIZE64x32, 4,  0, 0, 0, SP_ATK2_RL,20, 0 },
...
const ANIME		SP_ATK_R[] = {
	{ sp_21_r_Char, SIZE32x32, 8, 0,  0, 0, SP_ATK_D, 0, 0 },
	{ sp_22_r_Char, SIZE32x64, 4, 0,-34, 0, SP_ATK_D,10, 0 },
	{ sp_23_r_Char, SIZE32x32, 4, 0,  0, 0,        0, 0, 0 },
	{ sp_24_r_Char, SIZE32x32, 8, 0,  0, 0,        0, 0, 0 },
	{ NULL, 0xED, 0xED, 0xED, 0xED, 0, 0, 0, 0 }	// 終端データ
};
const ANIME		SP_ATK2_R[] = {
	{ sp_25_r_Char, SIZE32x32, 8, 0,  0, 0, SP_ATK2_D, 0, 0 },
	{ sp_26_r_Char, SIZE32x64, 4, 0,-34, 0, SP_ATK2_D,20, 0 },
...
const ANIME		SP_SKILL_F[] = {
	{ sp_41_f_Char, SIZE32x32, 8, 0, 0, SP_BODY_F, 0, 0, 0 },
	{ sp_42_f_Char, SIZE32x32, 4, 0, 0, SP_BODY_F, 0, 0, 0 },
	{ sp_43_f_Char, SIZE32x32, 4, 0, 0, SP_BODY_F, 0, 0, 0 },
	{ sp_42_f_Char, SIZE32x32, 4, 0, 0, SP_BODY_F, 0, 0, 0 },
	{ sp_43_f_Char, SIZE32x32, 4, 0, 0, SP_BODY_F, 0, 0, 0 },
	{ sp_42_f_Char, SIZE32x32, 4, 0, 0, SP_BODY_F, 0, 0, 0 },
	{ sp_43_f_Char, SIZE32x32, 4, 0, 0, SP_BODY_F, 0, 0, 0 },
	{ sp_44_f_Char, SIZE32x32, 8, 0, 0, SP_BODY_F, 0, 0, 0 },
	{ NULL, 0xED, 0xED, 0xED, 0xED, 0, 0, 0, 0 }	// 終端データ
};
// 横
const ANIME		SP_SKILL_S[] = {
	{ sp_41_s_Char, SIZE32x32, 8, 0, 0, SP_BODY_S, 0, 0, 0 },
	{ sp_42_s_Char, SIZE64x32, 4, 0, 0, SP_BODY_S, 0, 0, 0 },
	{ sp_43_s_Char, SIZE64x32, 4, 0, 0, SP_BODY_S, 0, 0, 0 },
	{ sp_42_s_Char, SIZE64x32, 4, 0, 0, SP_BODY_S, 0, 0, 0 },
	{ sp_43_s_Char, SIZE64x32, 4, 0, 0, SP_BODY_S, 0, 0, 0 },
	{ sp_42_s_Char, SIZE64x32, 4, 0, 0, SP_BODY_S, 0, 0, 0 },
	{ sp_43_s_Char, SIZE64x32, 4, 0, 0, SP_BODY_S, 0, 0, 0 },
	{ sp_44_s_Char, SIZE32x32, 8, 0, 0, SP_BODY_S, 0, 0, 0 },
	{ NULL, 0xED, 0xED, 0xED, 0xED, 0, 0, 0, 0 }	// 終端データ
};
// 後
const ANIME		SP_SKILL_R[] = {
	{ sp_41_r_Char, SIZE32x32, 8, 0,  0, SP_BODY_F, 2,10, 0 },
	{ sp_42_r_Char, SIZE32x64, 4, 0,-32, SP_BODY_F, 2,10, 0 },
	{ sp_43_r_Char, SIZE32x64, 4, 0,-32, SP_BODY_F, 2,10, 0 },
	{ sp_42_r_Char, SIZE32x64, 4, 0,-32, SP_BODY_F, 2,10, 0 },
	{ sp_43_r_Char, SIZE32x64, 4, 0,-32, SP_BODY_F, 2,10, 0 },
	{ sp_42_r_Char, SIZE32x64, 4, 0,-32, SP_BODY_F, 2,10, 0 },
	{ sp_43_r_Char, SIZE32x64, 4, 0,-32, SP_BODY_F, 2,10, 0 },
	{ sp_44_r_Char, SIZE32x32, 8, 0,  0, SP_BODY_F, 2,10, 0 },
	{ NULL, 0xED, 0xED, 0xED, 0xED, 0, 0, 0, 0 }	// 終端データ
};
...
// 魔法弾命中
const ANIME		MG_SHOT_D[] = {
	{ mg_shot_21_Char, SIZE16x16, 8,  -8,-10, 0, 0, 0, 0 },
	{ mg_shot_22_Char, SIZE16x16, 8, -10,-10, 0, 0, 0, 0 },
	{ mg_shot_23_Char, SIZE16x16, 8, -10,-10, 0, 0, 0, 0 },
	{ NULL, 0xED, 0xED, 0xED, 0xED, 0, 0, 0, 0 }	// 終端データ
};
// 技攻撃
