...
u8 ObjAction( u8 No, const ANIME *pAnime )
{
	...
	switch ( (pAnime + ObjBuf[No].Anime)->Size ){
		case SIZE8x8 :
			CpuFastCopy( (pAnime + ObjBuf[No].Anime)->Char, ObjBuf[No].Destp,   32 );
			break;
		case SIZE16x8 :
		case SIZE8x16 :
			CpuFastCopy( (pAnime + ObjBuf[No].Anime)->Char, ObjBuf[No].Destp,   64 );
			break;
		case SIZE16x16 :
		case SIZE32x8 :
		case SIZE8x32 :
			CpuFastCopy( (pAnime + ObjBuf[No].Anime)->Char, ObjBuf[No].Destp,  128 );
			break;
		case SIZE32x16 :
		case SIZE16x32 :
			CpuFastCopy( (pAnime + ObjBuf[No].Anime)->Char, ObjBuf[No].Destp,  256 );
			break;
		case SIZE32x32 :
			CpuFastCopy( (pAnime + ObjBuf[No].Anime)->Char, ObjBuf[No].Destp,  512 );
			break;
		case SIZE64x32 :
		case SIZE32x64 :
			CpuFastCopy( (pAnime + ObjBuf[No].Anime)->Char, ObjBuf[No].Destp, 1024 );
			break;
		case SIZE64x64 :
			CpuFastCopy( (pAnime + ObjBuf[No].Anime)->Char, ObjBuf[No].Destp, 2048 );
			break;
		default:
	}
	// ======== CPUコピーによる転送サイズの分岐 ======= E
