...
EX	OAM_TYPE	OamBuf[128];			// 仮想OAM RAM領域
EX	u8			StringNo;				// 表示文字列スプライトNo

EX  vu16		Key,OldKey,Trg;
EX	vu16		SioKey[4];				// 現在のキー入力
EX	vu16		SioTrg[4];				// 現在のトリガー入力
EX	vu16		SioOldKey[4];				// 一つ前のキー入力
EX	vu16		KeyBuf[KEY_BUF_SIZE];	// キー入力履歴

EX	u32			Hoffset;				// 画面ワールドX座標(16-16の固定小数点)
EX	u32			Voffset;				// 画面ワールドY座標(16-16の固定小数点)

EX	ANIME		*NowAnime;				// 現時点のアニメーション先頭アドレス
EX	ANIME		*NowAnime2;				// 現時点の敵アニメーション先頭アドレス

EX	u8			SpBgCnt;				// 画面フラッシュ用のカウンタ
EX	u8			PlayerNo;				// プレイヤー用添え字
EX	u8			EnemyNo;				// 敵番号用添え字
EX	u8			MapNo;
EX	u8			Clear;					// 倒した敵の数をカウント
EX	u8			EnemyCnt;				// 次の敵参照用カウンタ
...
// ======= ゲームデータの外部参照宣言部 ======= S
extern const u8		bg_woods_main_01_Character[8*8/2*177];	// 
extern const u16	bg_woods_main_01_Map[128*128];			// ワールドマップデータ
extern const u8		bg_woods_Wall[128][128];
extern const u16	bg_woods_main_01_Palette[16];

extern const u8		bg_dungeon_main_Character[8*8/2*75];	// 
extern const u16	bg_dungeon_main_Map[128*128];			// ワールドマップデータ
extern const u8		bg_dungeon_Wall[128][128];
extern const u16	bg_dungeon_main_Palette[16];

extern const u16	bg_woods_Map[64][64];							// ワールドマップデータ
extern const u32	c_SinTbl[256+64];		// サインテーブル
extern const u32	c_DivRoot2[];

extern const HIT_TYPE	ATTACK[];				// 攻撃範囲データ
extern const PLAYER		PLAYER_STATUS[];		// プレイヤー 基本ステータス
...
extern const u16	bg_woods_Palette[16];				// 背景フォントパレットデータ
extern const u8		bg_woods_Character[8*8/2*200];		// 背景フォントキャラクターデータ
...
extern const u16	title_ground_bg_Palette[16];			// タイトル崖
extern const u8		title_ground_bg_Character[8*8/2*112];
extern const u16	title_ground_bg_Map[32*32];
...
extern const u8		special_flash_05_Character[8*8/2*13];
extern const u8		special_flash_06_Character[8*8/2*10];

extern const u16	special_flash_01_Map[32*32];
extern const u16	special_flash_02_Map[32*32];
extern const u16	special_flash_03_Map[32*32];
extern const u16	special_flash_04_Map[32*32];
extern const u16	special_flash_05_Map[32*32];
extern const u16	special_flash_06_Map[32*32];
...
extern const u8		fire_01_Char[];
extern const u8		fire_02_Char[];
extern const u8		fire_03_Char[];
extern const u8		fire_04_Char[];

extern const u8		splash_ef_01_Char[];
extern const u8		splash_ef_02_Char[];
extern const u8		splash_ef_03_Char[];
extern const u8		splash_ef_04_Char[];

extern const u8		start_logo_Char[];
extern const u8		title_logo_left_Char[];
extern const u8		title_logo_right_Char[];
...
//extern const ANIME	SPECIAL_FLASH[];
extern const ANIME	FIRE[];
extern const ANIME	SPLASH_EF[];

// 立ち絵データ
extern const ANIME	TITLE_BEAST[];
extern const ANIME	TITLE_MAGIC[];
extern const ANIME	TITLE_PETIT[];
extern const ANIME	TITLE_POWER[];
extern const ANIME	TITLE_SPEED[];
...
extern const ANIME	START_LOGO[];
extern const ANIME	TITLE_LOGO_R[];
extern const ANIME	TITLE_LOGO_L[];

// その他
extern const ANIME	E_BAR_PROTO[];
extern const ANIME	COIN_ANIME[];


extern const u8		*SPECIAL_FLASH_CHARACTER[];
extern const u16	*SPECIAL_FLASH_MAP[];
extern const u8		*WALL_MAP[];

// 追加分

extern const u8		knight_01_Char[];
...
extern const u8		kani_arm_l_01_Char[];
extern const u8		kani_arm_l_02_Char[];
extern const u8		kani_arm_l_03_Char[];
extern const u8		kani_arm_r_01_Char[];
extern const u8		kani_arm_r_02_Char[];
extern const u8		kani_arm_r_03_Char[];
extern const u8		kani_body_Char[];
extern const u8		kani_leg_l_01_Char[];
extern const u8		kani_leg_l_02_Char[];
extern const u8		kani_leg_l_03_Char[];
extern const u8		kani_leg_l_04_Char[];
extern const u8		kani_leg_r_01_Char[];
extern const u8		kani_leg_r_02_Char[];
extern const u8		kani_leg_r_03_Char[];
extern const u8		kani_leg_r_04_Char[];

// ボスデータ
extern const ANIME	KNIGHT_STAND[];
extern const ANIME	KNIGHT_ATK[];
extern const ANIME	KNIGHT_GUARD[];
extern const ANIME	KANI_BODY[];
extern const ANIME	KANI_ARM_L[];
extern const ANIME	KANI_ARM_R[];
extern const ANIME	KANI_LEG_L[];
extern const ANIME	KANI_LEG_R[];
