...
OFS_MS_SYNC_RECV_FLAG           *   4       ; 受信確認フラグ

OFS_MS_START_FLAG               *   8       ; 通信開始フラグ
OFS_MS_HARD_ERROR               *   9       ; ハードエラー
...
OFS_MS_NEXT_SEND_BUF_P          *   40      ; 送信バッファポインタ
OFS_MS_CURRENT_SEND_BUF_P       *   44
OFS_MS_CURRENT_RECV_BUF_P       *   48      ; 受信バッファポインタ
OFS_MS_LAST_RECV_BUF_P          *   64
OFS_MS_RECV_CHECK_BUF_P         *   80

OFS_MS_SEND_BUF                 *   96      ; 送信バッファ（ダブルバッファ）
