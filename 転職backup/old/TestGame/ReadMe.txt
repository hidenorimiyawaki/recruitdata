========================================================================
    WIN32 アプリケーション : TestGame プロジェクトの概要
========================================================================

AppWizard はユーザー用に TestGame アプリケーションを作成しました。  
このファイルには TestGame アプリケーションを構成している
各ファイルの概要が含まれています。
...
TestGame.ico
    ...
    このアイコンはメイン リソース ファイル TestGame.rc に含まれています。

small.ico
    これはアイコン ファイルです。アプリケーション アイコンの小さいバージョンを含みます (16x16)。
    このアイコンはメイン リソース ファイル TestGame.rc 
    に含まれています。
...
StdAfx.h, StdAfx.cpp
    これらのファイルはプリコンパイル済みヘッダー (PCH) ファイル TestGame.pch、
